...
import cn.carbrand.data.bean.AllCarBrandJSONBean;
import cn.carbrand.data.bean.AllCarBrandJSONBean.CarBrandOBJ;
import okhttp3.Call;
...
public class DataFetcherUtils {
	...
	private static void step0(){
		...
		for(CarBrandOBJ obj : bean.getInfo()){
	...
	private static void downloadImageResources(String urlString, String toDir) {
		...
		String savePath = toDir + fileName;
	...
	private static String fetechNetWorkData(String urlString) {
